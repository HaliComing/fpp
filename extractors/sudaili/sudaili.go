...
func (e *extractor) Extract() ([]*models.ProxyIP, error) {
	...
	html, err := client.Request("GET", "http://www.sudaili.com/free.html", nil,
		request.WithHeader(http.Header{
			"Referer":    {"http://www.sudaili.com/"},
	...
	dom.Find("div table.freeTable > tbody > tr").Each(func(i int, s *goquery.Selection) {
